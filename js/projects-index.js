    ...
    return (
      '<article class="vcp-card project-card">' +
        '<div class="vcp-card__body">' +
          (project.logo
            ? '<span class="vcp-logo-chip vcp-logo-chip--uniform" style="margin-bottom: var(--space-3);"><img src="' + escapeHtml(project.logo) + '" alt="" loading="lazy"></span>'
            : '') +
          ...
          '<div class="project-card__links">' +
            '<a class="vcp-link" href="project-detail.html?slug=' + encodeURIComponent(project.slug) + '" data-dip-title="' + escapeHtml(project.name) + '">View project &rarr;</a>' +
            (project.website
